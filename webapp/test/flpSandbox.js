		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bidding Controller Portal",
									"targetURL": "#comnauticontrollerportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnauticontrollerportal-display": {
								"semanticObject": "comnauticontrollerportal",
								"action": "display",
								"description": "Portal for Live Bidding Controller",
								"title": "Bidding Controller Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nauti.controllerportal",
									"url": sap.ui.require.toUrl("com/nauti/controllerportal")
								}
							}
						}
					}
